...
// Log define
#define GTP_INFO(fmt,arg...)           elog_i("gt9xx", fmt, ##arg)
#define GTP_ERROR(fmt,arg...)          elog_e("gt9xx", fmt, ##arg)
#define GTP_DEBUG(fmt,arg...)          do{\
                                         if(GTP_DEBUG_ON)\
                                         elog_d("gt9xx", "[%d]"fmt, __LINE__, ##arg);\
																					}while(0)

#define GTP_DEBUG_ARRAY(array, num)    do{\
                                         if(GTP_DEBUG_ARRAY_ON)\
                                         {\
                                            elog_hexdump("gt9xx", 16, (array), (num));\
                                        }\
                                       }while(0)

#define GTP_DEBUG_FUNC()               do{\
                                         if(GTP_DEBUG_FUNC_ON)\
                                         elog_d("gt9xx", "Func:%s@Line:%d", __func__, __LINE__);\
                                       }while(0)
